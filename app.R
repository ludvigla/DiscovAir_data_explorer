    ...
    fluidRow(
      tabBox(
        ...
        tabPanel(
          value = 3, 
          title = "section 3", 
          column(width = 12, leafletOutput("map3", width = "100%", height = "800px"))),
        tabPanel(
          value = 5, 
          title = "section 5", 
          column(width = 12, leafletOutput("map5", width = "100%", height = "800px"))),
        tabPanel(
          value = 6, 
          title = "section 6", 
          column(width = 12, leafletOutput("map6", width = "100%", height = "800px"))),
        tabPanel(
          value = 7, 
          title = "section 7", 
          column(width = 12, leafletOutput("map7", width = "100%", height = "800px"))),
        tabPanel(
          value = 8, 
          title = "section 8", 
          column(width = 12, leafletOutput("map8", width = "100%", height = "800px")))
      ),
      bsModal(
        id = "modalExample", 
...
server <- function(input, output, session) {
  ...
  observeEvent(ifelse(req(input$tabset1 == "8"), 
                      list(input$map8_zoom, input$var, input$gene, input$scalealpha), 
                      list()), {
    i <- 8
    c(data, variable, pal, pal_rev) %<-% get_data()
    proxy <- leafletProxy(paste0("map", i))
